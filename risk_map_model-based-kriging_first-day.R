...
shapefile.path <- "Ireland-shapefile_Boundary-coords.txt"
...
win.graph(width = map.width, height = map.height, pointsize = 12)
...
country.boundary <- read.table("Ireland-shapefile_Boundary-coords.txt", header=T)
